...
class TestProjectKeywordThemes(BaseALPSAPIAutomation):
    ...
    #API_URL = 'http://uat5.smallbizvoices.com/alps/dashboard/iquanti/projects/224/projectkeywordthemes?sort_by=theme_name&&limit=10&session_token=alps_st_018mh5zlp4srdum5zuzmu3onyrm9008c'
