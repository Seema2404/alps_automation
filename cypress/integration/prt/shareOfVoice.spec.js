    ...
    it('verify Share Of Voice homepage', () => {
        ...
        cy.enter(prtKeywordExplorer.elements.iFrame, prtKeywordExplorer.elements.iFrameUrl).then(getBody => {
            ...
            getBody().find('h3.preTextWithEllipsis').contains('Keyword Count')
                .should('be.visible')
            getBody().find('.scrollWrapper div p span').contains('Share of Voice by Business Type')
                .should('be.visible')
            getBody().find('.scrollWrapper div p span').contains('Share of Voice by Domain')
                .should('be.visible')
        ...
        cy.enter(prtKeywordExplorer.elements.iFrame, prtKeywordExplorer.elements.iFrameUrl).then(getBody => {
            ...
            getBody().find('h3.preTextWithEllipsis').contains('Keyword Count')
                .should('be.visible')
            getBody().find('h3.preTextWithEllipsis').contains('Traffic')
                .should('be.visible')
            getBody().find('h3.preTextWithEllipsis').contains('Share of Voice')
                .should('be.visible')
            getBody().find('.scrollWrapper div p span').contains('Share of Voice by Category')
                .should('be.visible')
        ...
        cy.enter(prtKeywordExplorer.elements.iFrame, prtKeywordExplorer.elements.iFrameUrl).then(getBody => {
            ...
            getBody().find('.scrollWrapper div p span').contains('FILTERS')
                .should('be.visible')
            getBody().find('button.themableBackgroundColor span').contains('SELECT THE METRIC')
                .should('be.visible')
            getBody().find('.scrollWrapper div p span').contains('Share of Voice Trends')
                .should('be.visible')
            getBody().find('svg.cartesianChart').should('be.visible')
            getBody().find('button.themableBackgroundColor span').contains('Traffic')
                .click({ force: true })
            cy.wait(5000)
            getBody().find('.scrollWrapper div p span').contains('Traffic Trends')
                .should('be.visible')
            getBody().find('svg.cartesianChart').should('be.visible')
        })
    })
