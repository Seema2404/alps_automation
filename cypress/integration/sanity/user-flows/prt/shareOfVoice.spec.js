    ...
    it('verify Share Of Voice homepage', () => {
        ...
        cy.enter(prtKeywordExplorer.elements.iFrame, prtKeywordExplorer.elements.iFrameUrl).then(getBody => {
            ...
            getBody().find('h3.preTextWithEllipsis').contains('Keyword Count')
                .should('be.visible')
            getBody().find('h3.preTextWithEllipsis').contains('Share of Voice by Business Type')
                .should('be.visible')
            getBody().find('h3.preTextWithEllipsis').contains('Share of Voice by Domain')
                .should('be.visible')
        ...
        //         .should('be.visible')
        //     getBody().find('h3.preTextWithEllipsis').contains('Share of Voice by Category')
        //         .should('be.visible')
        ...
        //         .should('be.visible')
        //     getBody().find('h3.preTextWithEllipsis').contains('Share of Voice Trends')
        //         .should('be.visible')
        //     getBody().find('svg.cartesianChart').should('be.visible')
